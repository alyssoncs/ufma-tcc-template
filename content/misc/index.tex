...
Prefixos binários também estão disponíveis (kibi, mebi, gibi, etc), assim como macros para bit e byte, por exemplo: \verb|\unit[per-mode=symbol]{\mibi\byte\per\second}|, produz \unit[per-mode=symbol]{\mibi\byte\per\second}.
